...
process.on('uncaughtException',async (reason,p) => {
  client.channels.cache.get('599272915153715201').send('uncaught'+inspect(reason),{split:true}).then(msg=>setTimeout(()=>msg.delete(),5000))
  client.channels.cache.get('599272915153715201').send('uncaught'+inspect(p),{split:true}).then(msg=>setTimeout(()=>msg.delete(),5000))
});
